...
import FollowerCard from "../followersmodal/followercard/FollowerCard"
                ...
                <ModalContent className="pb-4">
                    ...
                    <ModalBody className="scrollbar-thin scrollbar-thumb-gray-200 scrollbar-thumb-rounded-full">
                        <div className="h-[420px]">
                            {following.map((e: any) => <FollowerCard key={e.id} id={e.id} name={e.name} imageUrl={e.imageUrl} email={e.email} />)}
                        </div>
                    </ModalBody>
                </ModalContent>
            </Modal>
