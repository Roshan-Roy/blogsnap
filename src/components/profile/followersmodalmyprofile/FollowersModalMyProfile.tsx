            ...
            <Modal isOpen={isOpen} onOpenChange={onOpenChange} scrollBehavior="inside" radius="sm" size="2xl">
                <ModalContent className="pb-4">
                    ...
                    <ModalBody className="scrollbar-thin scrollbar-thumb-gray-200 scrollbar-thumb-rounded-full">
                        ...
                        {followers.map((e: any) => <FollowersCardMyProfile key={e.id} id={e.id} userId={e.FollowedBy.id} name={e.FollowedBy.name} imageUrl={e.FollowedBy.imageUrl} email={e.FollowedBy.email} />)}
                        </div>
                    </ModalBody>
                </ModalContent>
            </Modal>
