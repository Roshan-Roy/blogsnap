...
const AllBlogs = () => {
    ...
    const fetchAllBlogs = async () => {
        try {
            const res = await fetch("/api/allblogs")
            ...
            <div className="flex items-center justify-center h-20 sticky top-[80px] bg-white z-50 border-b-1">
                <div className="w-9/12 flex justify-between">
                    ...
                    <div className="flex gap-2">
                        <Button as={Link} href="/all/allblogs" className="w-36 text-white bg-gray-800">All</Button>
            ...
            <div>
                {loading ? <p>Loading</p> : error ? <div>
                    ...
                    <Button onPress={() => {
                        ...
                        setError(false)
                        fetchAllBlogs()
                    }}>Try Again</Button></div> : <div className="w-7/12 mx-auto grid grid-cols-3 gap-4 mb-20 mt-5">
                    {filteredBlogs.map(e => {
